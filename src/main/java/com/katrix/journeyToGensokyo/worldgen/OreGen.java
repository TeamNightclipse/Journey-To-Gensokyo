...
public class OreGen implements IWorldGenerator {
	...
	public OreGen() {
	    this.genGensoOre = new WorldGenMinable(JTGBlock.gensokyoOreBlock, 0, 6, Blocks.stone);
	    this.genMakaiOre = new WorldGenMinable(JTGBlock.gensokyoOreBlock, 1, 6, Blocks.netherrack);
	    this.genCelestialOre = new WorldGenMinable(JTGBlock.gensokyoOreBlock, 2, 6, Blocks.end_stone);
	}
	...
	public void generate(Random random, int chunkX, int chunkZ, World world,
	    ...
	    case 0: //Overworld
	    	runGenerator(genGensoOre, world, random, chunkX, chunkZ, 8, 0, 32);
	        break;
	    case -1: //Nether
