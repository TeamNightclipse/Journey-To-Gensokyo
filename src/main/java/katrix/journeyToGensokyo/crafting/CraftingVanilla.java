...
public class CraftingVanilla {
	...
	public static void init() {
		...
		GameRegistry.addRecipe(new ItemStack(JTGItem.standardShot, 1, 0), "sps", "yhy", "sps", 'p', THKaguyaItems.red_pearl, 's', THKaguyaItems.arrow_shot, 'h',
				THKaguyaItems.hakurei_miko_stick, 'y', THKaguyaItems.yin_yang_orb);

		GameRegistry.addRecipe(new ItemStack(JTGItem.standardShot, 1, 1), "sps", "yhy", "sps", 'p', THKaguyaItems.orange_pearl, 's',
				THKaguyaItems.homing_amulet, 'h', THKaguyaItems.hakurei_miko_stick, 'y', THKaguyaItems.yin_yang_orb);

		GameRegistry.addRecipe(new ItemStack(JTGItem.standardShot, 1, 2), "sps", "hmb", "sps", 'p', THKaguyaItems.white_pearl, 's', THKaguyaItems.long_laser,
				'm', THKaguyaItems.mini_hakkero, 'h', THKaguyaItems.marisa_hat, 'b', THKaguyaItems.magic_bloom);

		GameRegistry.addRecipe(new ItemStack(JTGItem.standardShot, 1, 3), "sps", "hmb", "sps", 'p', THKaguyaItems.aqua_pearl, 's', THKaguyaItems.star_shot, 'm',
				THKaguyaItems.mini_hakkero, 'h', THKaguyaItems.marisa_hat, 'b', THKaguyaItems.magic_bloom);
	}
}
