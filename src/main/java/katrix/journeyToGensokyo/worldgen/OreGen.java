...
public class OreGen implements IWorldGenerator {
	...
	public OreGen() {
	    this.genGensoOre = new WorldGenMinable(JTGBlock.gensokyoOreBlock, 0, 4, Blocks.stone);
	    this.genMakaiOre = new WorldGenMinable(JTGBlock.gensokyoOreBlock, 1, 4, Blocks.netherrack);
	    this.genCelestialOre = new WorldGenMinable(JTGBlock.gensokyoOreBlock, 2, 4, Blocks.end_stone);
	}
