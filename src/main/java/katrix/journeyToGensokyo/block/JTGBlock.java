...
public class JTGBlock {
	...
	public static void preInit() {
		...
		keyStoneBlock = new BlockKeyStone(Material.rock).setBlockName("keyStoneBlock").setBlockTextureName("journeytogensokyo:keyStone");
		...
		compDemonOreBlock = new BlockJTGBase(Material.rock).setBlockName("demonOreBlock").setBlockTextureName("journeytogensokyo:demonOre");
		compCelestialOreBlock = new BlockJTGBase(Material.rock).setBlockName("celestialOreBlock").setBlockTextureName("journeytogensokyo:celestialOre");
