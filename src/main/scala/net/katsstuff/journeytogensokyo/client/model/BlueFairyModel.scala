...
object BlueFairyModel extends ModelFairy {
  textureWidth = 64
  textureHeight = 32
  ...
  val ribbon    = new ModelRenderer(this, 42, 14)
  ...
  ribbon.setRotationPoint(0.0F, -2.0F, -0.7F)
  ribbon.addBox(-4.0F, -5.0F, 3.5F, 8, 10, 1)
