...
import net.katsstuff.teamnightclipse.danmakucore.entity.living.ai.FlyingRandomPositionGenerator
...
import net.katsstuff.teamnightclipse.danmakucore.scalastuff.{DanmakuCreationHelper, TouhouHelper}
